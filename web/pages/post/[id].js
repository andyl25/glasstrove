...
function Home() {
  ...
  const { loading, error, data, refetch } = useQuery(PICTURE, {
    variables: { id },
    onCompleted: (data) => {
      Mixpanel.track("Post Page View", { post: id });
    },
  });
  ...
  return (
    <div className="flex flex-col min-h-screen overflow-hidden">
      ...
      <main class="page-wrapper">
        {!loading && !error && data.specificPost.length > 0 && (
          <section class="sidebar-enabled sidebar-end">
            <div class="container">
              <div class="row">
                ...
                <div class="col-lg-3 sidebar pt-5 pt-lg-7 order-lg-2">
                  <div class="px-sm-4 pt-6 py-lg-6 position-relative zindex-5">
                    ...
                    <ul class="list-unstyled fs-md mb-4 pb-2">
                      <li class="mb-1">
                        User:
                        <a href={"/" + data.specificPost[0].owner.username}>
                          <span class="fw-medium text-nav ms-2">
                            {data.specificPost[0].owner.username}
                          </span>
                        </a>
                      </li>
                      <li class="mb-1">
                        Followers:
                        <span class="fw-medium text-nav ms-2">
                          {data.specificPost[0].owner.numfollowers}
                        </span>
                      </li>
                    </ul>
                ...
                {/* <!-- image--> */}
                <div
                  class="col-lg-9 content pt-2 pt-lg-7 pb-lg-4 order-lg-1"
                  id="gallery"
                >
                  <div class="gallery-item rounded-3 mb-grid-gutter">
                    ...
                    <img
                      src={data.specificPost[0].imageUrl}
                      alt={data.specificPost[0].title}
                    ></img>
                    {/* </a> */}
