  ...
  _getNextPositions(items) {
    ...
    if (this.options.isCentered) {
      const itemsData = items.map((item, i) => {
        ...
        const point = this._getItemPosition(itemSize, i);
    ...
    return items.map((item, i) => this._getItemPosition(Shuffle.getSize(item.element, true), i));
  }
